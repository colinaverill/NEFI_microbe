...
#load data.----
fg <- readRDS(ted_ITS.prior_dmulti.ddirch_fg_JAGSfit)
pl <- readRDS(ted_ITS.prior_dmulti.ddirch_fg_JAGSfit)
...
n.plots <- round(pl.count / n.panels)
...
#Divide obs by read depth - 1k reads.
obs <- obs / 1000
